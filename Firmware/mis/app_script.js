...
var SS = SpreadsheetApp.openById('1yjyVV3q72PRA5J0EQE1nxn1RGrfFWmOufe9fMPaWLO0');
var str = "";
    ...
    if (parsedData !== undefined) {
        ...
        switch (parsedData.command) {
            ...
            case "append_row":
                ...
                publish_array[5] = status;   // add value2 from Arduino code to position 4 in publish_array
